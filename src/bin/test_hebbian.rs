...
use microresolve::scoring::saas_test_graph;
...
fn main() {
    ...
    println!("\n  Note: only Morphological + Abbreviation rewrite the query at runtime.");
    println!("  Synonym + Semantic edges are stored for inspection only.");
}
