...
The embedded `Engine` runs entirely in-process. For teams that want a shared training pipeline — auto-learn, Studio UI, review queue — you can point the engine at a self-hosted server using connected mode.
