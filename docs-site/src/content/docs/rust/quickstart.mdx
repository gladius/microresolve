...
```rust
use microresolve::{Engine, EngineConfig, IntentSeeds};
...
<Aside type="tip">
For the full method listing see the [Rust API Reference](/rust/api/).
</Aside>

## Next

- [Rust API Reference](/rust/api/) — complete method listing
- [Connect to server](/rust/connect/) — sync a local engine with the self-hosted server
