...
- [Benchmarks](/benchmarks/) — measured accuracy under real conditions
- [Threshold Tuning](/threshold-tuning/) — reduce false positives without sacrificing recall
- [Concepts](/concepts/) — how the scoring model works
