...
Every change auto-commits to the git data layer. Use [History](/server/git-data/) to see or roll back changes.
...
See [Git Data Layer](/server/git-data/) for the underlying mechanics and the corresponding HTTP API.

## Next

- [Git Data Layer](/server/git-data/) — audit trail, rollback, remote sync
- [Server API Reference](/server/api/) — call the same operations programmatically
- [Auth](/server/auth/) — restrict access to the Studio and API
