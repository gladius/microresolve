...
// Synonym kind is legacy: existing synonym edges may still appear in the list
// (for inspection), but query-time synonym expansion is disabled and new ones
// can't be added from the UI.
      ...
      <div className="space-y-5">
        ...
        {info && (
          <div className="flex items-center gap-4 text-xs font-mono text-zinc-500 bg-zinc-900/50 border border-zinc-800 rounded-lg px-4 py-2">
            ...
            {info.l1.edges_synonym > 0 && (
              <Stat label="synonym (legacy)" value={info.l1.edges_synonym.toLocaleString()} />
            )}
            <Sep />
        ...
        {/* Distill CTA — morphology + abbreviation edges only; synonym injection removed */}
