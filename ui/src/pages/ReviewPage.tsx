...
import { api, type ReviewItem, type FullReviewResult } from '@/api/client';
import { useAppStore } from '@/store';
import Page from '@/components/Page';

type FeedEvent =
  | { type: 'item_queued';  id: number; query: string; app_id: string }
...
function CopyAnalysisButton({ item, analysis }: { item: ReviewItem; analysis: FullReviewResult }) {
...
function ReviewDetail({ item, intents, onFixed, onDismiss }: {
  ...
  const [analysis,    setAnalysis]    = useState<FullReviewResult | null>(null);
